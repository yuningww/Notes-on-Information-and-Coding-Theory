...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{BasicModel.jpg}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\linewidth]{DistributionInference.jpg}
    \caption{$P(x\mid \lambda)$ as a function of $x$ and $\lambda$. If $x$ is fixed, then it is the likelihood function of $\lambda$.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
    \includegraphics[width=0.9\linewidth]{SampleInference.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{MutualInfo.png}
...
\begin{figure}[H]
    \begin{subfigure}{0.45\textwidth}
    \includegraphics[width=0.9\linewidth]{h_p.jpg}
    ...
    \hfill
    \begin{subfigure}{0.45\textwidth}
    \includegraphics[width=0.9\linewidth]{H2_p.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\linewidth]{tpical_set.jpg}
...
\begin{enumerate}
  ...
  \begin{figure}[H]
  \centering
  \includegraphics[width=0.4\linewidth]{sourcecoding.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\linewidth]{ChannelBigPicture.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\linewidth]{NoisyChannelTheorem.png}
