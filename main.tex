...
The \textbf{Shannon information content},
  ...
  \]
is a measure of the information content of the outcome $x=a_i$, and it measures the length of the binary file that encodes the outcome. The \textbf{entropy} of the ensemble,
  \[
